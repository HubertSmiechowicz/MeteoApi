...
namespace MeteoApi.Tests.Models
{
    public class CloudsTests
    {
        ...
        [InlineData(200, "")]
        [InlineData(300, "")]
        public void GetCloudImage_ForDifferentsAllAndRainEquals0_ReturnCorrectImage(int all, string imageUrl)
        {
            // arrange
        ...
        [InlineData(1)]
        [InlineData(1.2)]
        public void GetCloudImage_ForAllBetween0And100AndRainAbove_ReturnRainImage(double rainArg)
        {
            // arrange
